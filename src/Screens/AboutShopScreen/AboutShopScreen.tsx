    ...
    <>
      ...
      <RowTextContainer>
        <Text color={colors.black} size="16px" fontStyle={fonts.f400}>
          В период прохождения таких супермногодневок как "Тур де Франс", Джиро
          д'Италия", "Вуэльта" и т.д. с новой силой вспышивают допинговые
          скандалы. Нужны ли допинг тесты - если да - то какие - это очень
          сложный вопрос. Но факт в том - что текущее состояние дел не идет на
          пользу велоспорту в целом. Мы приводим кусок интервью Валерий Карпина
          - президента профессиональной испанской велокоманды Karpin Galicia -
          кореспонденту издания СпортЭкспресс.
          <br />
          <br />В период прохождения таких супермногодневок как "Тур де Франс",
          Джиро д'Италия", "Вуэльта" и т.д. с новой силой вспышивают допинговые
          скандалы. Нужны ли допинг тесты - если да - то какие - это очень
          сложный вопрос. Но факт в том - что текущее состояние дел не идет на
          пользу велоспорту в целом. Мы приводим кусок интервью Валерий Карпина
          - президента профессиональной испанской велокоманды Karpin Galicia -
