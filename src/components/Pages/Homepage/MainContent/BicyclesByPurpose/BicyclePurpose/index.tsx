...
const BicyclePurpose = ({ purpose }: BicyclePurposeProps) => (
  ...
  >
    <div className="relative sm:w-full md:w-full xl:w-full 2xl:w-full w-[159.5px] h-[88px] xl:h-[116px] lg:h-[236px] lg:w-[316px] shrink-0">
      <Image
        src={purpose.image}
    ...
    <div className="bg-dark flex flex-col items-center justify-center py-3 xl:pt-3 xl:pb-4 lg:pt-3 lg:pb-4">
      <h3 className="font-semibold leading-[19px] sm:text-center">
        {purpose.name}
      </h3>
