...
const BicyclePurpose = ({ purpose }: BicyclePurposeProps) => (
  <div className="rounded-lg overflow-hidden max-w-[316px] sm:max-w-full md:max-w-full xl:max-w-full lg:max-w-full 2xl:max-w-full">
    <div className="relative sm:w-full md:w-full xl:w-full lg:w-full 2xl:w-full w-[159.5px] h-[88px] xl:h-[116px] lg:w-[316px] lg:h-[236px] shrink-0">
      <Image
        src={purpose.image}
    ...
    <div className="bg-dark flex flex-col items-center justify-center py-3 xl:pt-3 xl:pb-4">
      <h3 className="font-semibold leading-[19px]">{purpose.name}</h3>
      <div className="w-[28px] h-[2.5px] bg-gradient-custom rounded-full mt-[6px] mb-2 xl:mb-3" />
