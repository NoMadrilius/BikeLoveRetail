...
const HeroTitle = () => {
  return (
    <div className="px-5 relative grow">
      <span className="text-gray lg:text-[200px] text-[120px] font-bold leading-[120%] uppercase sm:relative sm:-top-[13px] font-robot">
        Bike
      </span>
      <div className="absolute top-[11.91px] left-[20px] lg:top-[104.54px] lg:left-[54.36px] md:w-[377px] z-[1]">
        <h1 className="text-[32px] leading-[37.5px] lg:text-[40px] md:text-[40px] md:leading-[44px] font-medium text-dark pr-5 lg:pr-0 font-robot-c sm:max-w-[313.74px]">
